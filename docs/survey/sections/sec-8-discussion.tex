...
\begin{enumerate}
  \item \textbf{Feed-forward 4DGS.} Eliminate per-scene
        ...
        \item \textit{Project fit:} \checkmark{}~feed-forward maps
              directly to Snapdragon~8~Elite (SM8750, formerly leaked as '8~Gen~4') inference throughput.
  ...
  \item \textbf{4DGS ray tracing.} The 4DGRT~\cite{liu20254dgrt}
        ...
        \item \textit{What the next paper should look like:} a
              ...
              on Snapdragon~8~Elite (SM8750, formerly leaked as '8~Gen~4').
        \item \textit{Project fit:} \textbf{!}~mobile RT is not
              on the immediate Snapdragon~8~Elite (SM8750, formerly leaked as '8~Gen~4') / Vulkan~1.3
  ...
  \item \textbf{Temporal compression.} Dynamic / static separation
        ...
        \item \textit{What the next paper should look like:} a
              ...
              P-4DGS~\cite{wang2025p4dgs}\footnote{\textbf{P-4DGS vs PD-4DGS.} P-4DGS (Wang et al., USTC, CVPR~2025, $\sim$90$\times$ compression via motion-prediction residuals, see~\texttt{wang2025p4dgs}) and PD-4DGS (Li et al., Qilu Univ.~of~Tech., arXiv~2026, 3--5-layer progressive decomposition, see~\texttt{li2026pd4dgs}) are two \emph{distinct} codecs from \emph{different} research groups. They are listed as separate building blocks in the standardisation discussion below. The single-letter difference makes them easy to confuse; we treat them as two independent codecs throughout this survey.}.
  ...
  \item \textbf{Generative 4DGS.} The L2D2-GS feed-forward route
        ...
        \item \textit{Project fit:} \textbf{!}~exciting but
              currently compute-bound; a Snapdragon~8~Gen~4
  ...
  \item \textbf{4DGS standardisation.} The 4DGS community
        ...
        \item \textit{Missing piece:} an MPEG- or
              ...
              + PD-4DGS~\cite{li2026pd4dgs} trio are three
              \emph{de-facto} building blocks (P-4DGS handles
              motion-prediction residuals; PD-4DGS handles
              hierarchical bandwidth adaptation; the two address
              different axes and could in principle be composed).
        \item \textit{What the next paper should look like:} a
              reference encoder / decoder pair with bitstream
        ...
        \item \textit{Quantitative target:} a reference
              ...
              Snapdragon~8~Gen~4 device, on a 20~MB 4DGS
...
4DGS-1K $\sim$2--10~MB in 2025, 4DGS-CC $<$1~MB in 2025). Both
