...
The survey's primary bibliography covers the 60 most-cited works
in the discussion above; the following nine paper notes were
written during the 2026-08-13 P36 enrichment pass (commit
\texttt{fa1b687}) and contain grounded quantitative claims that
directly inform the future-directions discussion. They are
cluster-cited here for reader convenience, and the per-paper
details are in \texttt{docs/appendix/paper-notes/}. Affected
themes: \textbf{compression + dynamic/static separation}
(CATSplat~\cite{roh2025catsplat}, MaGS~\cite{ma2025mags},
LUDVIG~\cite{marrie2025ludvig}, SplatTalk~\cite{thai2025splattalk},
...
(FreeSplatter~\cite{xu2025freesplatter}); \textbf{adversarial
robustness}
(StealthAttack~\cite{ke2025stealthattack}).
