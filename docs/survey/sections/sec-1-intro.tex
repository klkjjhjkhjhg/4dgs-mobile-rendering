...
constrained to $\sim$10--15~FPS at 1080p on a desktop GPU (M\"uller et al. 2022, Instant-NGP). \emph{3D Gaussian
Splatting} (2023) broke this barrier by replacing the MLP
with an explicit Gaussian set and a differentiable rasteriser,
reaching $\sim$30~FPS at 1080p on a desktop GPU (Kerbl et al. 2023, A6000, Mip-NeRF 360; subsequent follow-ups reach 60--100+~FPS via culling and CUDA-specific optimisations). The 4DGS
